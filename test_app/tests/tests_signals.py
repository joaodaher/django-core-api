...
from django_core_api.serializers import as_str
from django_core_api.signals import UnplugSignal
from django_core_api.tests import BaseApiTest
from test_app import signals, models
from test_app.tests.tests_base import HogwartsTestMixin
from test_app.models import Wizard, Teacher, Spell, Wand, House, SpellCast
...
class TestSoftDeleteSignals(HogwartsTestMixin, BaseApiTest):
    ...
    def test_soft_delete_model(self):
        ...
        with self.patch_task() as some_task:
            memory.delete()
