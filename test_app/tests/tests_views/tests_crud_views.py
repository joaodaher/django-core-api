...
class TestCRUDView(HogwartsTestMixin, BaseApiTest):
    ...
    def test_post_endpoint_with_existing(self):
        ...
        klass_name = 'django_core_api.views.viewsets.MultiSerializerMixin.perform_create'
        error = IntegrityError('duplicate key value violates unique constraint for bla bla bla')
