...
from test_app.models import Wizard, Teacher, House, Patronus, Spell, SpellCast
...
class HogwartsTestMixin:
    ...
    def expected_wizards(self):
        return [
            {'name': 'Harry Potter', 'is_half_blood': True},
            {'name': 'Hermione Granger', 'is_half_blood': True},
            {'name': 'Draco Malfoy', 'is_half_blood': False},
            {'name': 'Sirius Black', 'is_half_blood': False},
        ]
